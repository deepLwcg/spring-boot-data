...
public class TaskLoadData implements Runnable {
    ...
    public TaskLoadData(RestTemplate restTemplate, LoadData loadData, CountDownLatch countDownLatch) {
    ...
    public void run() {
        ...
        try {
            ...
            if (Objects.isNull( download ) || StringUtils.isEmpty( uri ) || !(URL_PATTERN.matcher( uri ).matches())) {
                ...
                remoteDownload.setRestTemplate( restTemplate );
